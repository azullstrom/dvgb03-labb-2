...
class TerminalUI:
    ...
    def show_2d(self):
        ...
        index = 0
        padding = 8
        margin_in_between = padding * self._tree.height()
        margin_left = margin_in_between - padding
        ...
        for i in range(self._tree.height()):
            ...
            for j in range(2**i):
                if nodes[index] is not None:
                    ...
                    print("*", end='')
                index += 1
                print(" " * margin_in_between, end='')
            margin_left = int(margin_left - (float(margin_in_between / 3.7)))
            margin_in_between = int(margin_in_between / 2)
            print('')
